...
through the syntax `Integer.sum of map each individual
among individuals to individual.number_of_children`. Notice the specific `Integer` version of the `sum` function, which
